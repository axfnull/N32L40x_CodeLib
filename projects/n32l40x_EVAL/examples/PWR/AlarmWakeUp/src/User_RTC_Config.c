...
/**
 * @brief  Config the alarm time interrupt exti18.
 */
...
/**
 * @brief  RTC alarm value config,and print the config information.
 */
...
/**
 * @brief  RTC date value config,and print the config information.
 */
...
/**
 * @brief  RTC time value config,and print the config information.
 */
